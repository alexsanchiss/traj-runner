        ...
        try:
            ...
            if not line:
                if process.returncode is not None:
                    print("El proceso PX4 terminó antes de que apareciera 'Startup script returned successfully'")
                    break
                continue
            decoded_line = line.decode().strip()
            print(decoded_line)
            if "Startup script returned successfully" in decoded_line:
                print("Mensaje 'Startup script returned successfully' detectado")
